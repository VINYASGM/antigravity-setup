...
## Members
- [[ADR-0005]] - concept - tests/test-hooks.js
- [[ADR-0006]] - concept - tests/test-hooks.js
- [[SCRIPTS_DIR]] - code - tests/test-hooks.js
- [[WORKSPACE_DIR]] - code - tests/test-hooks.js
- [[assert()]] - code - tests/test-hooks.js
